...
# POST：データベースに投稿を保存
# トップページ(http://127.0.0.1:5000)と紐づけ
...
# http://127.0.0.1:5000/create と紐づけ
@app.route('/create')
def create():
...
# http://127.0.0.1:5000/detail と紐づけ
...
# http://127.0.0.1:5000/delete と紐づけ
...
# http://127.0.0.1:5000/update と紐づけ
